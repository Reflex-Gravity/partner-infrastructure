...
import GenderBased from './modules/GenderBased';
import CountryBased from './modules/CountryBased';
  ...
  const RenderDashboard = () => {
    // Render dashboard based sort type selection.
      ...
      switch (sortType) {
        ...
        case "genderSort": return(
          <GenderBased
            peopleData={peopleData}
          />
        );

        case "countrySort": return(
          <CountryBased
            peopleData={peopleData}
          />
        );
